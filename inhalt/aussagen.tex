...
Em algumas células unitárias existem alguns tipos básicos: simples, de corpo centrado e de faces centradas.
 ...
 Oi será que esta funcionando corretamente. Não sei. será que ele concerta ou esploração 
 
 \includegraphics[scale=0.5,trim={0 0 0 0}]{figures/var3}

 Se eu escrevo alguma coisa e salvo, já aparece para eu poder commitar
 
 
 Talquei. Agora eu sei que eu consigo pegar o documento aqui. Mas e para fazer upload do mesmo para o git. Esse será o teste.


Porém esse deu tanta dor de cabeça que fiquei na duvida
mmm
...
vai toma no cu essa porra



Agora sera que eu entendi como tem que fazer.
